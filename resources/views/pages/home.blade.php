                        ...
                        <div id="storeCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="/images/banner.jpg" alt="Caraousel Image" class="d-block w-100" />
                                </div>
        ...
        <section class="store-trend-categories">
            <div class="container">
                ...
                <div class="row">
                    ...
                    {{-- Cek data nya ada atau engga menggunakan @forelse --}}
        ...
        <section class="store-new-products">
            <div class="container">
                ...
                <div class="row">
                    ...
                    {{-- Increment untuk animasi delat --}}
                    @php $incrementProduct = 0 @endphp

                    {{-- Perulangan untuk cek ada data dan menampilkan --}}
