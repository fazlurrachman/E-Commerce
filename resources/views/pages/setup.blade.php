            ...
            <div class="card">
                ...
                <div class="card-body" id="divFormSupp">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="txtNama" placeholder="Masukkan nama penguji"
                            value="Aditia Darma">
                    </div>
                    <div class="form-group">
                        <label for="company">Min. Support</label> <small>Semakin rendah nilai support akan semakin banyak
                    ...
                    <div class="form-group">
                        <a class="btn btn-primary" href="javascript:void(0)" onclick="prosesApriori()">Mulai Analisa
                            Penjualan</a>
                    </div>
                </div>
